    ...
    public ResultForm(bool isWin)
        ...
        private void DisplayResult()
        {
            if (isWin)
            {
               ...
               SoundPlayer winSoundPlayer = new SoundPlayer(Resources.wingame); // Replace with the path to your win sound file
               winSoundPlayer.Play();
            }
            else
            {
                ...
                this.BackgroundImage =Resources.loss; // Change the background color for a loss.
